    ...
    <html>
        ...
        <body>
            <h1 class="col-lg-offset-4">Formulaire d'envoi de mail</h1>
                ...
                <br/><form method="post" action="Mail.php" class="col-lg-offset-3">
                        <label>E-mail : </label> 
                    ...
                    <br/><button class="btn btn-success col-lg-2 col-lg-offset-2" type="submit" value ="Valider" name='envoye'>Envoi</button>
                    </form>
